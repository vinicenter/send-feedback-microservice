...
export function ScreenShotButton({screenshot, onScreenshotTaken}: ScreenshotButtonProps) {
    ...
    return (
        <button
            ...
            className="h-10 w-10 p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
